                            ...
                            <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <td class="px-4 py-3 text-sm w-32">
                                    <a href="{{ route('userDetails', ['user' => $client->id]) }}" >
                                        ...
                                        <form action="{{ route('deleteUser', $client->id) }}" method="POST" style="display:inline;" onsubmit="return confirm('Are you sure you want to delete this user?');">
                                            @csrf
                                            @method('DELETE')
                                            <button type="submit" class="bg-red-500 text-white p-3 rounded-md hover:bg-red-700">
                                                Delete
                                            </button>
                                        </form>
                                    </a>
